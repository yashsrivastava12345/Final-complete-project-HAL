...
def image_match(video_frame_path, directory_path, threshold=0):
...
for video_path in video_paths:
    ...
    while True:
        ...
        for face in faces:
            ...
            t = ski.filters.threshold_otsu(cv2.cvtColor(crop,cv2.COLOR_BGR2GRAY))
            matched = image_match(crop, directory_path,threshold=t)
            diff =  ImageChops.difference(crop, matched[1])
